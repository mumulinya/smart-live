...
2. 看 [数据模型与核心表关系概览](/site-pages/DATA_MODEL)，把订单、钱包、积分、互动、AI 这些核心数据关系讲清楚。
3. 看 [项目级能力亮点](/site-pages/CORE_HIGHLIGHTS)，把“项目整体强在哪”讲清楚。
4. 再去 [页面效果图导览](/PAGE_GALLERY) 和 [业务链路视觉走查](/SHOWCASE)，把系统能力和真实页面、链路图对上。
