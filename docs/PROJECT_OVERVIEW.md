...
4. [性能指标与结果](/site-pages/PERFORMANCE)
5. [数据建模与表关系怎么讲](/DATA_MODEL_INTERVIEW)
6. [技术选型理由](/site-pages/TECH_SELECTION)
7. [难点踩坑与解决方案](/site-pages/PITFALLS)
8. [未来规划 Roadmap](/site-pages/ROADMAP)
9. [核心架构拷问 FAQ](/site-pages/FAQ)
...
若关注重点是“这个项目里的 Spring AI 和 RAG 是否真正落地”，推荐先看下面这张总图，再决定是否继续深入源码。
...
3. 看 [性能指标与结果](/site-pages/PERFORMANCE)，把性能与工程表现补齐。
4. 看 [数据建模与表关系怎么讲](/DATA_MODEL_INTERVIEW)，把交易、资产和互动的建模思路讲清楚。
5. 再回到 [技术选型理由](/site-pages/TECH_SELECTION)、[难点踩坑与解决方案](/site-pages/PITFALLS) 和 [核心架构拷问 FAQ](/site-pages/FAQ)，把“为什么这样做”和“怎么回答追问”补齐。
