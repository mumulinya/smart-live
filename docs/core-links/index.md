...
1. 先从 **秒杀 / 订单支付 / Redis** 这三条链路建立对项目交易闭环和高并发设计的认识
2. 再看 **RabbitMQ / 审核与搜索**，理解异步解耦、责任链治理和多模块协作
3. 最后看 **Feed / AI / 热榜**，把社交分发、业务增强生成和推荐维护串起来
...
如果你拿这页讲项目，最有价值的不是把 9 条链路全讲一遍，而是用这些数据先说明：
...
| 想讲 AI 落地 | [AI 路由策略与 RAG 生成](/core-links/8.%20AI%20Agent策略路由与RAG多维增强生成链路) | 最能体现 AI 不只是聊天，而是融合业务；页面里已经补了“建库链路 + 问答链路”的核心总图 |
...
如果你刚好是从 AI / Spring AI / 向量检索这几个关键词进入仓库，建议这一条不要跳着看。先看它新增的核心总图，再看里面拆出来的“知识建库链路”和“在线问答链路”，会更容易理解 SmartLive 这套为什么属于业务数据型 RAG，而不是单纯的聊天外挂。
