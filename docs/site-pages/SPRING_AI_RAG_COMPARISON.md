...
如果关注点是“这个项目里的 Spring AI 用法是不是和别人不一样”，这页就是对应的说明页。
...
### 1.2 当前项目不是“没做 RAG”，而是做的不是文档型 RAG
...
## 5. 当前项目的 Spring AI 用法与常见项目有何不同

### 5.1 一样的地方

从基础框架层看，当前实现仍然在使用标准的 Spring AI 能力：
...
所以更准确的说法不是“这套 Spring AI 用法不正规”，而是：

**当前项目把 Spring AI 用成了一套更贴近生产业务的 AI 服务底座。**
...
> 这个项目里的 Spring AI 跟别人有什么不一样？这算不算正规 RAG？
