...
- **底层能力**：
  - 基于 Spring AI + 向量检索实现多类业务增强
  - 拆成 `店铺 / 商品 / 博客 / 评价` 四类向量空间
  - 通过 `AgentRouter + LlmIntentClassifier` 做意图判断与路由决策
...
## 11. 为什么用 ZSet 存列表，String 存详情，不统一都用 Hash？
...
## 12. AbstractInteractionStrategy 为什么值得讲？
...
## 13. 如何高效地同步 Redis 中的大量互动数据到 MySQL？
