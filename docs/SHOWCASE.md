...
## <a id="showcase-chains"></a>7. 核心链路图集

这里直接展示主链路预览图，详细实现继续保留 `详细版 SVG` 入口。

### 7.1 <a id="chains-trade"></a>交易与履约
...
### 7.4 <a id="chains-search"></a>内容审核与搜索
...
### 7.5 <a id="chains-social"></a>社交与消息
...
### 7.6 <a id="chains-rank"></a>排行、热度与推荐
...
### 7.8 <a id="chains-cache"></a>缓存与性能专题
...
### 7.9 <a id="chains-schedule"></a>调度与定时任务
