<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="blogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="探店的照片，最多9张，多张以","隔开" align="center" prop="images" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="探店的照片，最多9张，多张以","隔开" prop="images">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        images: [
          { required: true, message: "探店的照片，最多9张，多张以','隔开不能为空", trigger: "blur" }
        ],
        content: [
