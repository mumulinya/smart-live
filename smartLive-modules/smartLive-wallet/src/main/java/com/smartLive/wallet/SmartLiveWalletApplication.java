...
/**
 * Wallet module entrypoint.
 */
@EnableCustomConfig
@EnableRyFeignClients
@SpringBootApplication
public class SmartLiveWalletApplication {
    public static void main(String[] args) {
        SpringApplication.run(SmartLiveWalletApplication.class, args);
