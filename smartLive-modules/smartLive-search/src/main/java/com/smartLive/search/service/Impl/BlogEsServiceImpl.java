...
@Service
@Slf4j
public class BlogEsServiceImpl implements IBlogEsService {
    ...
    @Override
    public boolean insertOrUpdate(String indexName, String id, BlogDoc data) throws IOException {
        // 1. 数据校验
        validateBlog(data);
        // 2. 转换为JSON
        ...
        log.info("博客ES插入/更新成功：index={}, id={}", indexName, id);
        return true;
    }
