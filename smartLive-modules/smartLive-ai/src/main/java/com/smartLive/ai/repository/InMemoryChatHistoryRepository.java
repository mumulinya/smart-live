package com.smartLive.ai.repository;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.ObjectWriter;
import com.smartLive.ai.entity.po.Msg;
...
//        List<String> chatIds = chatHistory.get(type);
    ...
    private void init() {
        ...
        try {
            // 会话历史
            if (historyResource.exists() && historyResource.getFile().length() > 0) {
            ...
            // 会话记忆
            if (memoryResource.exists() && memoryResource.getFile().length() > 0) {
            ...
            log.warn("Failed to load chat history from files, starting with empty history", ex);
            // 保持初始化的空集合状态
            this.chatHistory = new HashMap<>();
        }
    }
