        ...
        try {
            switch (action) {
                case "TOOL_SEARCH_PRODUCT":
                    List<com.smartLive.ai.entity.vo.ProductVO> products = productRagService.getProductList(new com.smartLive.ai.entity.vo.ProductVO(), input);
                    return objectMapper.writeValueAsString(products);
                case "TOOL_GET_SHOP_METRICS":
                    List<com.smartLive.ai.entity.vo.ShopVO> shops = shopRagService.getShopList(new com.smartLive.ai.entity.vo.ShopVO(), input);
