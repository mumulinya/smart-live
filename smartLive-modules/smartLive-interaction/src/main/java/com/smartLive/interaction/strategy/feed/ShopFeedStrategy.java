...
@Component
public class ShopFeedStrategy implements FeedStrategy {
    @Autowired
    RedisService redisService;
    @Autowired
    private Map<Integer, ResourceStrategy> resourceStrategyMap;
    @Override
    public Integer getType() { return FeedTypeEnum.SHOP_FEED.getCode(); }
    ...
    public String getFeedKey(Long userId) {
        return FeedTypeEnum.SHOP_FEED.getFeedKeyPrefix() + userId;
    }
