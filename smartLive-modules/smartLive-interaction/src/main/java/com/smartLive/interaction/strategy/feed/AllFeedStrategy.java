...
@Component
public class AllFeedStrategy implements FeedStrategy {
    @Autowired
    RedisService redisService;
    @Autowired
    private Map<Integer, ResourceStrategy> resourceStrategyMap;
    @Override
    public Integer getType() { return FeedTypeEnum.ALL_FEED.getCode(); }
    ...
    public String getFeedKey(Long userId) {
        return FeedTypeEnum.ALL_FEED.getFullKey(userId);
    }
