...
@Component
@Slf4j
public class UserFeedStrategy implements FeedStrategy {
    @Autowired
    RedisService redisService;
    @Autowired
    private Map<Integer, ResourceStrategy> resourceStrategyMap;
    @Override
    public Integer getType() { return FeedTypeEnum.USER_FEED.getCode(); }
    ...
    public String getFeedKey(Long userId) {
        return FeedTypeEnum.USER_FEED.getFullKey(userId);
    }
